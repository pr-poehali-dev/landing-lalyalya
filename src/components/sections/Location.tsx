    ...
    <section id="location" className="bg-surface py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4 md:px-8">
        <div className="mb-10 flex items-center gap-3">
          <span className="text-sm font-bold uppercase tracking-widest text-accent">06</span>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mb-8 space-y-4 text-lg leading-relaxed text-muted-foreground">
              ...
              <p>
                Именно здесь состоится церемония открытия закладного камня будущему памятнику
